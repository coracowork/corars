# corars JSON Stream Protocol Spec

> This protocol defines the communication between corars (Rust CLI) and a host client (e.g., CoraCowork Electron app) via stdin/stdout JSON Lines.
...
- **Encoding**: UTF-8
- **Activation**: `corars --json-stream [other flags]`
...
corars --json-stream --session-id my-conv-123 --provider openai --model gpt-4o

# Resume an existing session
corars --json-stream --resume my-conv-123 --provider openai --model gpt-4o
```
